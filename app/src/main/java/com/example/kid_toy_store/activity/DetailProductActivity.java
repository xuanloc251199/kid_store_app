...
public class DetailProductActivity extends AppCompatActivity {
        ...
        call.enqueue(new Callback<Products>() {
            ...
            public void onResponse(Call<Products> call, Response<Products> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    mBinding.tvTotalPrice.setText(CurrencyFormatter.formatCurrency(products.getPrice()));
    ...
    private void addToCart() {
        ...
        CartItem cartItem = new CartItem(productId, quantity); // ID và userId không cần thiết khi thêm vào giỏ hàng

        Call<CartItem> call = apiService.addToCart("Bearer " + token, cartItem);
