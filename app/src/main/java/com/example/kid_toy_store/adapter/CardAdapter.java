...
import com.example.kid_toy_store.view.activity.EditPaymentMethodActivity;
...
public class CardAdapter extends RecyclerView.Adapter<CardAdapter.CardViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CardViewHolder holder, int position) {
        ...
        holder.tvCardNumber.setText(card.getCardNumber());  // Đã có dạng **** **** **** 1234 từ API
        holder.imgEditPaymentCard.setOnClickListener(v -> {
            Intent intent = new Intent(mContext, EditPaymentMethodActivity.class);
