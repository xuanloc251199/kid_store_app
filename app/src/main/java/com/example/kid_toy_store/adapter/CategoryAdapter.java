...
import com.example.kid_toy_store.activity.DetailCategoryActivity;
...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.CategoryViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CategoryViewHolder holder, int position) {
        ...
        holder.lnCategory.setOnClickListener(v -> mContext.startActivity(new Intent(mContext, DetailCategoryActivity.class)));
    }
