            ...
            public void onResponse(Call<UserResponse> call, Response<UserResponse> response) {
                if (response.isSuccessful()) {
                    ...
                    if (userResponse.getUser().getAddress() != null) {
                        ...
                        mBinding.tvShippingAddress.setText(R.string.add_shipping_address);
                    }
                } else {
        ...
        call.enqueue(new Callback<Card>() {
            ...
            public void onResponse(Call<Card> call, Response<Card> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    // Kiểm tra dữ liệu thẻ hợp lệ
                    if (validateCard(cardNumber, cardExpiryDate, cardCvv)) {
                        mBinding.tvCardNumber.setText(cardNumber);
                    }
                } else {
