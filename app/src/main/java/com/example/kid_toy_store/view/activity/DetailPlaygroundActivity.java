...
import com.example.kid_toy_store.model.CartRequest;
...
public class DetailPlaygroundActivity extends AppCompatActivity {
    ...
    private void setOnClickListener() {
        ...
        mBinding.cvBack.setOnClickListener(v -> onBackPressed());
        ...
        call.enqueue(new Callback<Tickets>() {
            ...
            public void onResponse(Call<Tickets> call, Response<Tickets> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    mBinding.tvTotalPrice.setText(CurrencyFormatter.formatCurrency(tickets.getPrice()));
                    ...
                    Toast.makeText(DetailPlaygroundActivity.this, "Không thể tải danh sách sản phẩm", Toast.LENGTH_SHORT).show();
                }
            }
